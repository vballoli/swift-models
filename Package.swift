...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "UNet-EMSegmentation", targets: ["UNet-EMSegmentation"]),
    ...
    targets: [
        ...
        .target(
            name: "UNet-EMSegmentation", dependencies: ["SegmentationModels", "Datasets"],
            path: "Examples/UNet-EMSegmentation"
        ),
        .target(
